		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #fff","width":"100%","padding":"0 20px 20px","fontSize":"14px","color":"#000","background":"#fff"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column  :resizable='true' prop="binglidan" width="200" label="病历单">
						<template slot-scope="scope">
							<div v-if="scope.row.binglidan">
								<img v-if="scope.row.binglidan.substring(0,4)=='http'&&scope.row.binglidan.split(',w').length>1" :src="scope.row.binglidan" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.binglidan)">
								<img v-else-if="scope.row.binglidan.substring(0,4)=='http'" :src="scope.row.binglidan.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView(scope.row.binglidan.split(',')[0])">
								<img v-else :src="$base.url+scope.row.binglidan.split(',')[0]" width="100" height="100" style="object-fit: cover" @click="imgPreView($base.url+scope.row.binglidan.split(',')[0])">
							</div>
							<div v-else>无图片</div>
						</template>
					</el-table-column>
