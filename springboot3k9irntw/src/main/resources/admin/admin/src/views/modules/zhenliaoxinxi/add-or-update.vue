	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-else-if="ruleForm.zhenliaoshijian" label="诊疗时间" prop="zhenliaoshijian" >
					<el-input v-model="ruleForm.zhenliaoshijian" placeholder="诊疗时间" readonly></el-input>
				</el-form-item>
			...
			<el-form-item v-else-if="ruleForm.zhenduanjieguo" label="诊断结果" prop="zhenduanjieguo" >
...
<script>
	export default {
		...
		created() {
			this.ruleForm.zhenliaoshijian = this.getCurDateTime()
		},
		methods: {
			// 下载
			download(file){
