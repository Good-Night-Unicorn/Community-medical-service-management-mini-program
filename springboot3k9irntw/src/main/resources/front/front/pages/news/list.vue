			...
			<view :style='{"minHeight":"100vh","alignContent":"flex-start","padding":"20rpx 20rpx 240rpx","alignItems":"flex-start","flexWrap":"wrap","background":"linear-gradient(135.00deg, rgb(206, 209, 242),rgb(228, 185, 225) 100%)","display":"flex","width":"100%","height":"auto"}'>
				<view class="cu-bar bg-white search" :style='{"width":"100%","padding":"0","background":"none","display":"flex","height":"auto"}'>
					<view :style='{"margin":"0 12rpx","flex":"1","position":"relative"}' class="search-form round">
						...
						<input :style='{"border":"0","padding":"12rpx 20rpx 12rpx 80rpx","boxShadow":"inset 0px 2rpx 8rpx 0px rgb(131, 122, 161)","color":"#333","borderRadius":"40rpx","background":"#fff","width":"100%","lineHeight":"56rpx","fontSize":"28rpx","height":"80rpx"}' v-model="searchForm.title" type="text" placeholder="标题" ></input>
					</view>
				...
				<view :style='{"padding":"10rpx","margin":"10rpx 0","borderRadius":"10rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%"}'>
					<view @click="sortClick('clicknum')" :style='{"border":"2rpx solid #E4ADD7","padding":"0 12rpx","margin":"0 8rpx 0 0","outline":"0","borderRadius":"6rpx","background":"#F6F6FF","display":"flex"}'>
						<text :style='{"color":"#E4ADD7","lineHeight":"40rpx","fontSize":"24rpx"}'>点击量</text>
						<text v-if="listSort!='clicknum'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 0 0 4rpx","lineHeight":"40rpx","fontSize":"24rpx","color":"#E4ADD7"}'></text>
						<text v-else-if="listSort=='clicknum'&&listOrder=='asc'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 0 0 4rpx","lineHeight":"40rpx","fontSize":"24rpx","color":"#E4ADD7"}'></text>
						<text v-else-if="listSort=='clicknum'&&listOrder=='desc'" class="icon iconfont icon-xiaoliang13" :style='{"margin":"0 0 0 4rpx","lineHeight":"40rpx","fontSize":"24rpx","color":"#E4ADD7"}'></text>
					</view>
				...
				<view :style='{"alignContent":"flex-start","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto"}'>
					...
					<!-- 样式4 -->
					<view v-if="list.length" class="news-box4" :style='{"padding":"20rpx","margin":"0","borderRadius":"20rpx","background":"#fff","flex":"1","width":"calc(100% - 180rpx)","height":"auto"}'>
						<block v-for="(product,index) in list" :key="index">
							<view @tap="onDetailTap(product)" v-if="index%2==0" class="list-item" :style='{"boxShadow":"inset 0px 2rpx 8rpx 0px rgb(131, 122, 161)","padding":"20rpx 0 20rpx 20rpx","margin":"0 0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
								<image :style='{"width":"200rpx","objectFit":"cover","display":"block","height":"160rpx"}' mode="aspectFill" class="listmpic" :src="baseUrl+product.picture"></image>
								<view class="list-item-body" :style='{"padding":"0","margin":"0","flexWrap":"wrap","display":"flex","width":"calc(100% - 200rpx)","justifyContent":"space-between","height":"auto"}'>
									<view :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
									<view :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#AEAEAE","width":"100%","lineHeight":"48rpx","fontSize":"24rpx","textOverflow":"ellipsis"}' class="text ">{{product.introduction}}</view>
									...
									<view :style='{"padding":"0 20rpx","display":"inline-block","order":"2"}'>
										...
										<text :style='{"color":"#8FA771","lineHeight":"40rpx","fontSize":"24rpx"}'>{{product.name}}</text>
									</view>
									<view :style='{"padding":"0 20rpx","display":"inline-block","order":"3"}'>
										<text class="icon iconfont icon-zan10" :style='{"margin":"0 4rpx 0 0","lineHeight":"40rpx","fontSize":"24rpx","color":"#CAAEFF"}'></text>
										<text :style='{"color":"#CAAEFF","lineHeight":"40rpx","fontSize":"24rpx"}'>{{product.thumbsupnum}}</text>
									</view>
									...
									<view :style='{"padding":"0 20rpx","display":"inline-block","order":"5"}'>
										<text class="icon iconfont icon-chakan9" :style='{"margin":"0 4rpx 0 0","lineHeight":"40rpx","fontSize":"24rpx","color":"#FC6363"}'></text>
										<text :style='{"color":"#FC6363","lineHeight":"40rpx","fontSize":"24rpx"}'>{{product.clicknum}}</text>
									</view>
								</view>
							</view>
							<view @tap="onDetailTap(product)" v-if="index%2==1" class="list-item" :style='{"boxShadow":"inset 0px 2rpx 8rpx 0px rgb(131, 122, 161)","padding":"20rpx 20rpx 20rpx 0 ","margin":"0 0 20rpx","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","height":"auto"}'>
								<view class="list-item-body" :style='{"padding":"0","margin":"0","flexWrap":"wrap","display":"flex","width":"calc(100% - 200rpx)","justifyContent":"space-between","height":"auto"}'>
									<view :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#000","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis"}' class="title ">{{product.title}}</view>
									<view :style='{"padding":"0 20rpx","margin":"0","whiteSpace":"nowrap","overflow":"hidden","color":"#AEAEAE","width":"100%","lineHeight":"48rpx","fontSize":"24rpx","textOverflow":"ellipsis"}' class="text ">{{product.introduction}}</view>
									<view :style='{"padding":"0 20rpx","order":"1"}'>
