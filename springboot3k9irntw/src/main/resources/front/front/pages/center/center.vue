<template>
	<view class="content">
		<view :style='{"width":"100%","padding":"20rpx","flexWrap":"wrap","background":"linear-gradient(135.00deg, rgb(206, 209, 242),rgb(228, 185, 225) 100%)","display":"flex","height":"auto"}'>
			<view v-if="user&&user.id" :style='{"padding":"20rpx","margin":"0 0 20rpx 0","background":"url(http://codegen.caihongy.cn/20241223/a81c6d4a00574177b8d5b18113db720e.png) center center/100% 100% no-repeat","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="onPageTap('../user-info/user-info')" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='huanzhe'" class="userinfo">
					...
					<view :style='{"width":"240rpx","flex":"1","flexDirection":"column","justifyContent":"space-between","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000"}'>{{user.huanzhezhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"padding":"40rpx","margin":"30rpx 0 20rpx","borderRadius":"20rpx","flexDirection":"row","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}' class="info">
						<view :style='{"width":"30%","lineHeight":"36rpx","fontSize":"24rpx","alignItems":"center","flexDirection":"column","display":"flex"}'>
							<span :style='{"color":"#000"}'>患者电话：</span>
							<span :style='{"color":"#000"}'>{{user.huanzhedianhua}}</span>
						</view>
					</view>
				</view>
				<view :style='{"alignContent":"center","alignItems":"center","flexWrap":"wrap","flex":"1","display":"flex","height":"100%"}' v-if="tableName=='yisheng'" class="userinfo">
					<image :style='{"width":"88rpx","padding":"0","margin":"0 20rpx 0 0","borderRadius":"100%","height":"88rpx"}' :src="user.touxiang?baseUrl+user.touxiang:require('../../static/gen/upload.png')"></image>
					<view :style='{"width":"240rpx","flex":"1","flexDirection":"column","justifyContent":"space-between","display":"flex"}' class="info">
						<view :style='{"width":"100%","lineHeight":"36rpx","fontSize":"24rpx","color":"#000"}'>{{user.yishengzhanghao}}<text v-if="user.vip&& user.vip=='是'">(VIP)</text></view>
					</view>
					
					<view :style='{"padding":"40rpx","margin":"30rpx 0 20rpx","borderRadius":"20rpx","flexDirection":"row","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}' class="info">
						<view :style='{"width":"30%","lineHeight":"36rpx","fontSize":"24rpx","alignItems":"center","flexDirection":"column","display":"flex"}'>
							<span :style='{"color":"#000"}'>联系电话：</span>
							<span :style='{"color":"#000"}'>{{user.lianxidianhua}}</span>
						</view>
					</view>
				</view>
				<view :style='{"padding":"0 20rpx","alignItems":"center","borderRadius":"8rpx","top":"40rpx","flexDirection":"row","background":"#BDFDFC","display":"flex","width":"auto","position":"absolute","right":"20rpx","justifyContent":"center","height":"auto"}' class="setting">
					<text class="icon iconfont icon-qita6" :style='{"border":"0","margin":"0 4rpx 0 0","color":"#000","borderRadius":"0","width":"auto","lineHeight":"40rpx","fontSize":"32rpx"}'></text>
					<text :style='{"color":"#000","lineHeight":"40rpx","fontSize":"24rpx"}'>设置</text>
				</view>
			</view>
			
			<view v-else :style='{"padding":"20rpx","margin":"0 0 20rpx 0","background":"url(http://codegen.caihongy.cn/20241223/a81c6d4a00574177b8d5b18113db720e.png) center center/100% 100% no-repeat","display":"flex","width":"100%","position":"relative","height":"auto"}' @tap="loginClick" class="header" v-bind:class="{'status':isH5Plus}">
				<view :style='{"alignItems":"center","color":"#666","display":"flex","width":"100%","fontSize":"36rpx","justifyContent":"center","height":"240rpx"}'>登录/注册</view>
			</view>
