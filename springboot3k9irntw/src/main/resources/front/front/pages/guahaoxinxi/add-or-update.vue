...
<view class="content">
	<view :style='{"minHeight":"100%","padding":"20rpx","alignItems":"flex-start","background":"linear-gradient(135.00deg, rgb(206, 209, 242),rgb(228, 185, 225) 100%)","display":"flex","width":"100%","height":"auto"}'>
		<form :style='{"width":"100%","padding":"24rpx","borderRadius":"20rpx","background":"#fff","display":"block","height":"auto"}' class="app-update-pv">
			...
			<view :style='{"padding":"12rpx 0","boxShadow":"0px 8rpx 8rpx 0px rgb(234, 236, 255)","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class=" select">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"70rpx","fontSize":"28rpx","color":"#000","textAlign":"right"}' class="title">挂号状态</view>
				<picker :disabled="ro.guahaozhuangtai" :style='{"width":"100%","flex":"1","height":"auto"}' @change="guahaozhuangtaiChange" :value="guahaozhuangtaiIndex" :range="guahaozhuangtaiOptions">
					<view :style='{"width":"100%","padding":"0 20rpx","lineHeight":"80rpx","fontSize":"28rpx","color":"#D4C1D6"}' class="uni-input">{{ruleForm.guahaozhuangtai?ruleForm.guahaozhuangtai:"请选择挂号状态"}}</view>
				</picker>
			</view>
			<view :style='{"padding":"12rpx 0","boxShadow":"0px 8rpx 8rpx 0px rgb(234, 236, 255)","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
				<view :style='{"width":"160rpx","padding":"0 20rpx 0 0","lineHeight":"70rpx","fontSize":"28rpx","color":"#000","textAlign":"right"}' class="title">挂号时间</view>
				<input :disabled="ro.guahaoshijian" :style='{"border":"0","padding":"0px 20rpx","margin":"0px","color":"rgb(0, 0, 0)","borderRadius":"8rpx","flex":"1","background":"rgba(255, 255, 255, 0)","fontSize":"28rpx","height":"70rpx"}' v-model="ruleForm.guahaoshijian" placeholder="挂号时间" @tap="toggleTab('guahaoshijian')"></input>
			</view>
			<view :style='{"padding":"12rpx 0","boxShadow":"0px 8rpx 8rpx 0px rgb(234, 236, 255)","margin":"0 0 24rpx 0","borderColor":"#ccc","alignItems":"center","borderWidth":"0","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="">
...
<script>
	...
	export default {
		...
		async onLoad(options) {
			...
			this.ruleForm.yibaokahao = this.user.yibaokahao
		...
		methods: {
			...
			// 下拉变化
			guahaozhuangtaiChange(e) {
				this.guahaozhuangtaiIndex = e.target.value
				this.ruleForm.guahaozhuangtai = this.guahaozhuangtaiOptions[this.guahaozhuangtaiIndex]
			},
			...
			async onSubmitTap() {
				...
				if((!this.ruleForm.guahaoshijian)){
					this.$utils.msg(`挂号时间不能为空`);
					return
				}
				...
				//跨表计算
						...
						if(this.ruleForm.id){
							...
							oet = await this.$api.add(`guahaoxinxi`, this.ruleForm);
						}
						uni.showModal({
							title: '提交成功！',
							content: '是否跳转支付？',
